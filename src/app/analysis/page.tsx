                                                    ...
                                                    createdAt: c.createdAt || c.created_at,
                                                        extractedData: c.extractedData || c.extracted_data || {},
                                                            abusiveClauses: c.abusiveClauses || c.abusive_clauses || [],
                                                                alerts: c.alerts || [],
                                                                    summary: c.summary,
                                                                        // Enhanced fields for AnalysisResult
                                                                        noticePeriodDays: c.noticePeriodDays ?? c.notice_period_days ?? 30,
                                                                            terminationClauseReference: c.terminationClauseReference || c.termination_clause_reference || '',
                                                                                parties: c.parties || [],
                                                                                    tags: c.tags || [],
                                                                                        customQuery: c.customQuery,
                                                                                            customAnswer: c.customAnswer,
                                                                                                requestedDataPoints: Object.keys(c.extractedData || c.extracted_data || {}),
                    }));
